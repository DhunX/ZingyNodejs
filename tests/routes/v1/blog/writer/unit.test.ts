...
describe('Writer blog create routes', () => {
  ...
  it('Should send error if blog postUrl not sent', async () => {
    const response = await addAuthHeaders(
      request.post(endpoint).send({
        title: 'title',
        description: 'description',
  ...
  it('Should send error if blog postUrl is not in accepted format', async () => {
    const response = await addAuthHeaders(
      request.post(endpoint).send({
        title: 'title',
        description: 'description',
  ...
  it('Should send error if blog already exists for postUrl', async () => {
    const response = await addAuthHeaders(
      request.post(endpoint).send({
        title: 'title',
        description: 'description',
